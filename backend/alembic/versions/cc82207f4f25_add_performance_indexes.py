...
def upgrade() -> None:
    ...
    # Conditionally drop Better Auth tables if they exist
    conn = op.get_bind()
    inspector = sa.inspect(conn)

    # Drop tables that may exist from Better Auth, but don't fail if they don't
    for table_name in ['account', 'verification', 'session', 'user']:
